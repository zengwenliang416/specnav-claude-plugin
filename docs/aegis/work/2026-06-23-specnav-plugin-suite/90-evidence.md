# SpecNav plugin suite implementation - Evidence
...
- Type: test-output
- Source: bash tests/run-plugin-suite-resolver-fixtures.sh && zsh tests/run-plugin-suite-resolver-fixtures.sh && bash tests/run-plugin-suite-layout-fixtures.sh && node --check plugins/specnav-core/scripts/plugin-suite.js
...
- Type: test-output
- Source: bash tests/run-requirements-plugin-fixtures.sh && bash tests/run-core-runtime-fixtures.sh && bash tests/run-plugin-suite-resolver-fixtures.sh && bash tests/run-plugin-suite-layout-fixtures.sh && node --check plugins/specnav-requirements/scripts/foundation-specs.js && node --check plugins/specnav-requirements/scripts/requirements-contract.js
...
- Type: test-output
- Source: bash tests/run-prototype-plugin-fixtures.sh && bash tests/run-requirements-plugin-fixtures.sh && bash tests/run-core-runtime-fixtures.sh && bash tests/run-plugin-suite-resolver-fixtures.sh && bash tests/run-plugin-suite-layout-fixtures.sh && node --check plugins/specnav-prototype/scripts/prototype-contract.js
