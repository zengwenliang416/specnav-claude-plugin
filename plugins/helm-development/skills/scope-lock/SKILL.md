...
All paths must be relative clean strings. Block absolute paths, backslashes, `..`, empty strings, and padded strings. `prototype_sources` must point under `openspec/changes/<active-change>/prototype/` and must exist.
