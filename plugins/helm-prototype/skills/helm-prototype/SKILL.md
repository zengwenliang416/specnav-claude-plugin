...
4. Branch Classification: use `ui-html`, `logic-state`, `api-contract`, `data-flow`, or `component-seam`.
5. Write artifacts only under `openspec/changes/<active-change>/prototype/`.
6. Expose stable screen, component, state, and variant labels for review.
7. Rerun the contract before moving to verification.
